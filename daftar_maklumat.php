  ...
  <div role="main" class="ui-content">
	...
	<form id="form1">
		...
		<div data-role="fieldcontain">
			...
			<textarea name="alamat_kutipan" id="alamat_kutipan"><?php echo $alamat_kutipan;?></textarea>
		</div>
		...
		<div data-role="fieldcontain">
			...
			<input type="text" name="j_barang" id="j_barang" 
			value="<?php echo $j_barang;?>"/>
		</div>
	</form>
