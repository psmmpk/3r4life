    ...
    <?php 	
		...
		if ($rowcheckroute == 0){
			...
			while( $row = mysql_fetch_array($result)) 
			{
				...
				echo"<li><a href ='daftar_maklumat.php?syk_id=$syk_id' data-rel='external' data-ajax='false'><h3>$syk_nama</h3><p>$syk_alamat1</p><p>$syk_alamat2</p><p>$syk_poskod</p><p>$syk_bandar</p></a></li>";
			}		
		}
	?>
