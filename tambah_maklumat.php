...
// Connection to DB Server
    ...
    $insert = "INSERT INTO permohonan (pmh_sykid, pmh_nama, pmh_alamat1, pmh_notel, pmh_email , pmh_jenisbrng, pmh_status) VALUES ('$syk_id', '$nama', '$alamat_kutipan','$no_tel', '$email','$j_barang','A')";
    mysql_query($insert);
?>
